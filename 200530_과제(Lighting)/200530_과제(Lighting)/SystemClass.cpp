...
bool SystemClass::Initialize()
{
	...
	result = m_Input->ReadyInputDevice(m_hinstance, m_hwnd, screenWidth, screenHeight);
	if (!result) 
	{ 
...
bool SystemClass::Frame()
{
	...
	if (m_Input->GetDIKeyState(DIK_ESCAPE))
	{
		return false;
	}
	m_Graphics->MoveCamera(m_Timer->GetTime());
	m_Graphics->TurnLightOnOff();
