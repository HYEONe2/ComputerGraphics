...
ID3D11SamplerState * TextureShaderClass::Get_SamplerState()
{
	return m_sampleState;
}

void TextureShaderClass::Set_SamplerState(ID3D11SamplerState * pSamplerState)
{
	m_sampleState = pSamplerState;
}
